                    ...
                    <div>
                        <ul className="nav justify-content-center">
                            <li className="nav-item">
                                <Link className="nav-link active" to={`${this.state.url}/edit`}>Edit Profile</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`${this.state.url}/manageseller`}>Manage Sellers</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`${this.state.url}/managestore`}>Manage Stores</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`${this.state.url}/managecategories`}>Manage Categories</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`${this.state.url}/managebrands`}>Manage Brands</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`${this.state.url}/stats`}>View Stats</Link>
                            </li>
                        </ul>
                        <Switch>
                            <Route path="/profile/edit">
                                <div>
                                    ...
                                    <div className="form-group" style={{ padding: 10 }}>
                                        ...
                                        <input type="text" className="form-control" id="exampleInputUsername" name="username" value={this.state.username} onChange={this.change} />
                                    </div>
                                    <div className="form-group" style={{ padding: 10 }}>
                                        <label for="exampleInputEmail1">Email address</label>
                                        <input type="email" className="form-control" id="exampleInputEmail1" name="email" value={this.state.email} onChange={this.change} />
                                    </div>
